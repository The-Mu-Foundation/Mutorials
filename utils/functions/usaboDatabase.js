...
function updateUSABOCounters(req, question, correct) {
    ...
    db.collection("usaboQuestions").findOneAndUpdate({ _id: question._id }, { $set: { stats: { pass: question.stats.pass, fail: question.stats.fail } } });
}

module.exports = {
    getUSABOQuestion, getUSABOQuestions, updateUSABOCounters
};